        ...
        >
          <div className="flex min-w-0 gap-x-4 sm:shadow-sm flex-col w-full sm:w-52 h-full">
            ...
            <div className="pt-1 px-1 sm:p-2 sm:pb-4">
              <h3 className="test-text font-semibold uppercase">{item.entity}</h3>
            ...
            {item.entries.map((entry) => (
              ...
              >
                <div className="min-w-0 flex-auto">
                  <h4 className="text-sm/6 sm:text-base/6 font-semibold text-gray-900">
                    {entry.title}
                  </h4>
                  <div className="mt-1 lg:max-w-3/4 text-xs/5 sm:text-sm/5 tracking-wide font-light text-gray-600 whitespace-pre-line">
                    {entry.description}
                  </div>
                </div>
